...
const EmailSection = () => {
  ...
  return (
    <section
      id="contact"
      className="relative grid gap-4 py-24 my-12 font-title sm:pt-0 md:gap-6 sm:gap-8 md:grid-cols-2 md:my-12 sm:justify-items-center">
      ...
      <div className="z-10 mt-12">
        ...
        <div className="flex flex-row gap-2 socials sm:justify-items-center">
          <Link href="https://github.com/AnshKr2004">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/ansh-kumar-277260260">
